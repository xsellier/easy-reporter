...
function handler (request, h) {
  return ProjectModule.create(request.auth.credentials.token, request.payload.applicationId, request.payload.name, request.payload.secret, request.payload.email, request.payload.apiToken)
    .catch((err) => {
